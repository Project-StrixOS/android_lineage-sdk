...
public class ProfileManager {
    ...
    private ProfileManager(Context context) {
        ...
        if (context.getPackageManager().hasSystemFeature(
                strixos.app.LineageContextConstants.Features.PROFILES) && sService == null) {
    ...
    /**
     * Get or create an instance of the {@link strixos.app.ProfileManager}
     * @param context
