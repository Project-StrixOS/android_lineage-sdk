...
public class LineageGlobalActions {
    ...
    /**
     * Get or create an instance of the {@link strixos.app.LineageGlobalActions}
     * @param context
    ...
    public List<String> getLocalUserConfig() {
        try {
           ...
           // throw e.rethrowFromSystemServer();
            Log.e(TAG, "getLocalUserConfig", e);
    ...
    public String[] getUserActionsArray() {
        try {
            ...
            //throw e.rethrowFromSystemServer();
            Log.e(TAG, "getUserActionsArray", e);
            return new String[0];
        }
    }
    ...
    public boolean userConfigContains(String preference) {
        try {
            ...
            //throw e.rethrowFromSystemServer();
            Log.e(TAG, "userConfigContains", e);
            return false;
        }
    }
}
